...
img3 = load("/home/sankalpkarthi/Pictures/iceland11.jpg")
...
img4 = load("/home/sankalpkarthi/Pictures/iceland12.jpg")

# ╔═╡ 07e67c42-9271-4a9b-87ae-44d698a3b8de
imageinput,key1,key2,key3 = encrypt(img3,img4);

# ╔═╡ 06ad415c-8c8b-4653-af4e-765c607a8425
md"""
Message --> Cypher after Encryption
"""

# ╔═╡ e75aa384-c3c5-4701-8063-b1b91fe89b32
imageinput

# ╔═╡ d81c4b3a-3376-41c5-a52c-301dd2c24121
typeof(imageinput)

# ╔═╡ c2cd487c-0508-4040-9362-5bde88c8548c
md"""
Decrypting from Cypher --> Message
"""

# ╔═╡ 4ad828b2-be39-4ed7-9ddb-988fa291d25c
decrypt(imageinput,key1,key2,key3)[1]
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "7ab9b9add2e0d39bbd960551ca6ba42509eee13a"
